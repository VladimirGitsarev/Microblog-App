        ...
        return(
                <article className="post-container d-flex">
                    ...
                    <div>
                        ...
                        <p className="m-0"><b>{this.comment.user.first_name} {this.comment.user.last_name}</b></p>
                        <p className="m-0" style={{color:"#5b7083"}}>&nbsp;
                            <NavLink style={{ color:"#5b7083"}} to={"/user/" + this.comment.user.username}>@{this.comment.user.username}</NavLink>
                        </p>
                        <p className="m-0" style={{color:"#5b7083"}}>&nbsp;&middot;&nbsp;{this.formatDate(this.comment.created_at)}</p>
                        </div>
                        <div style={{color: "#5b7083", fontSize: "11pt"}} className=""> Answer to @{this.props.post.user.username}</div>
